...
/** Central cosmetic registry. v0.7 exposes three test options per major visual category. */
public final class CosmeticCatalog {
    ...
    // Unlock metadata remains in place for the later shop/progression system. v0.7 lets all
